  ...
  return (
    <div className="flex justify-center items-center py-8">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-2xl">Standard Deviation (Spread Around Mean) Calculator</CardTitle>
        ...
        <CardContent className="grid gap-4">
          ...
          {result && (
            <div className="p-4 bg-muted rounded-md text-center">
                <p>Sample Standard Deviation: <span className="font-bold">{result}</span></p>
            </div>
          )}
        </CardContent>
      </Card>
