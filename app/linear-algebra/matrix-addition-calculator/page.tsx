...
export default function MatrixAdditionCalculatorPage() {
  const [matrix1, setMatrix1] = useState("1, 2\n3, 4")
  const [matrix2, setMatrix2] = useState("5, 6\n7, 8")
  ...
  return (
    <div className="flex justify-center items-center py-8">
      <Card className="w-full max-w-2xl">
        <CardHeader>
          <CardTitle className="text-2xl">Matrix Addition Calculator</CardTitle>
        ...
        <CardContent className="grid gap-4">
          ...
          <Button onClick={calculate}>Add Matrices</Button>
